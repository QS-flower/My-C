...
// 文章详情页
articleApp.get('/:id', [article.getArticleById, article.getPrev, article.getNext], (req, res) => {
    let { article, categories, prev, next, user } = req
    res.render('article', { article: article, categories: categories, prev: prev, next: next, user: user })
})
